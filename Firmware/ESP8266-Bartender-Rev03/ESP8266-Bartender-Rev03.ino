...
void setup()
{
  ...
  Serial.begin( 115200 );
  Serial.println( "ESP8266 MQTT Bartender - Rev03" );
...
void loop()
{
  ...
  // Wait for aribitrary input from serial
  ...
  */
  ...
  Serial.println("Pushing 'ready' to MQTT");
  readyflag = "ready";
  // Prepare a string to publish the values to MQTT
  post[64]; readyflag.toCharArray(post, 64);
  // Publish the post to the topic:
